...
class PlateSimulationDriver:
    ...
    def run(self) -> UIJsonGroup:
        ...
        with fetch_active_workspace(self.params.geoh5, mode="r+"):
            ...
            if not isinstance(self.simulation_parameters.topography_object, Surface):
                raise ValueError(
    ...
    def surfaces(self) -> list[Surface]:
        ...
        if self._surfaces is None:
            ...
            surface = self.make_surface_from_plate(plate)
    ...
    def make_surface_from_plate(self, plate: Plate) -> Surface:
        """
